...
Before submitting a PR, manually verify on target OS: script runs without errors, all plugins load (`zinit list`), tmux plugins load, Starship prompt renders, fonts display correctly.
